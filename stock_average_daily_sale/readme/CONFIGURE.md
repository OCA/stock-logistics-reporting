- To configure data analysis, you should go to Inventory \>
  Configuration \> Average daily sales computation parameters
...
- Go to Configuration \> Technical \> Scheduled Actions \> Refresh
  average daily sales materialized view
