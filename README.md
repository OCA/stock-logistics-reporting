...
[stock_account_quantity_history_location](stock_account_quantity_history_location/) | 18.0.1.0.0 |  | Glue module between Stock Account and Stock Quantity History Location modules
...
[stock_picking_report_without_order_qty](stock_picking_report_without_order_qty/) | 18.0.1.0.0 |  | Hide delivery slip note report quantity field
...
[stock_quant_history](stock_quant_history/) | 18.0.1.0.0 | <a href='https://github.com/petrus-v'><img src='https://github.com/petrus-v.png' width='32' height='32' style='border-radius:50%;' alt='petrus-v'/></a> | Re-generate stock quants for given date
