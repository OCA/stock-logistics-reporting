...
[stock_picking_report_delivery_driver](stock_picking_report_delivery_driver/) | 16.0.1.0.0 | [![Shide](https://github.com/Shide.png?size=30px)](https://github.com/Shide) | Delivery Driver info in Stock Picking reports
