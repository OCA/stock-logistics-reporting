...
* **New Features**:
  ...
  - Integrated evaluation details field showing transaction-level cost breakdown
  - Added formatted value display for evaluation details

* **Technical Improvements**:

  - Ported FIFO/LIFO functionality from stock_close_period_evaluation_method module
  - Enhanced _evaluate_product() method to support new valuation methods
...
* **UI Enhancements**:
  ...
  - Made evaluation details optional/hidden in tree view for better performance
